...
export function createVocReceivedEmailHtml({
  company,
  category,
  title,
  writerName,
  vocId,
}: VocReceivedEmailProps) {
  const rows = [
    ["회사", company],
    ["유형", category],
    ["VOC 제목", title],
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0;">
            <tr>
              <td style="padding:28px 28px 20px; background:#eff6ff; border-bottom:1px solid #bfdbfe;">
                <div style="font-size:13px; font-weight:700; color:#2563eb; margin-bottom:10px;">VOC 신규 접수 알림</div>
                <h1 style="margin:0; font-size:24px; line-height:1.35; color:#0f172a;">새 VOC가 접수되었습니다.</h1>
                <div style="display:inline-block; margin-top:16px; padding:6px 12px; border-radius:999px; background:#dbeafe; color:#1d4ed8; font-size:13px; font-weight:700;">
                  상태: 접수
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:28px;">
                <p style="margin:0 0 20px; font-size:15px; line-height:1.7; color:#334155;">
                  담당자로 배정된 VOC가 접수되었습니다. 아래 내용을 확인해주세요.
                </p>
                ...
                <p style="margin:24px 0 0; font-size:15px; line-height:1.7; color:#334155;">
                  관리자 화면에서 상세 내용을 확인하고 처리 상태를 업데이트해주세요.
                </p>
              </td>
            </tr>
            <tr>
